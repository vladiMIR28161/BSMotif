...
3. file Branches.tsv — list of TF branches of similar TFBS motifs.

4. file Branches_logos.html — HTML table of motif branches containing the list of transcription factors, motif similarity values, and merged motif logos for each branch.
...
At this stage, make sure that Tomtom is installed and can be run as a command.
